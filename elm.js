...
Elm.InsuranceDropdown = Elm.InsuranceDropdown || {};
Elm.InsuranceDropdown.make = function (_elm) {
   "use strict";
   _elm.InsuranceDropdown = _elm.InsuranceDropdown || {};
   if (_elm.InsuranceDropdown.values) return _elm.InsuranceDropdown.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   _U.list([A2($Html.div,
           _U.list([$Html$Attributes.$class("col-sm6")]),
           _U.list([A2($Html.select,
           _U.list([$Html$Attributes.id("InsuranceProviderId")]),
           _U.list([A2($Html.option,_U.list([$Html$Attributes.value("1")]),_U.list([$Html.text("Carrier 1")]))
                   ,A2($Html.option,_U.list([$Html$Attributes.value("2")]),_U.list([$Html.text("Carrier 2")]))
                   ,A2($Html.option,_U.list([$Html$Attributes.value("3")]),_U.list([$Html.text("Carrier 3")]))
                   ,A2($Html.option,_U.list([$Html$Attributes.value("4")]),_U.list([$Html.text("Carrier 4")]))]))]))
           ,A2($Html.div,
           _U.list([$Html$Attributes.$class("col-sm6")]),
           _U.list([A2($Html.select,
           _U.list([$Html$Attributes.id("InsuranceCarrierId")]),
           _U.list([A2($Html.option,_U.list([$Html$Attributes.value("1")]),_U.list([$Html.text("Rep 1")]))
                   ,A2($Html.option,_U.list([$Html$Attributes.value("2")]),_U.list([$Html.text("Rep 2")]))
                   ,A2($Html.option,_U.list([$Html$Attributes.value("3")]),_U.list([$Html.text("Rep 3")]))
                   ,A2($Html.option,_U.list([$Html$Attributes.value("4")]),_U.list([$Html.text("Rep 4")]))]))]))]));
   return _elm.InsuranceDropdown.values = {_op: _op,main: main};
};
